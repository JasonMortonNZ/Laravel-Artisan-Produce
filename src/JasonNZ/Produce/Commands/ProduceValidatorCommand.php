...
class ProduceValidatorCommand extends Command {
	 ...
	 * @var string
	 */
	protected $name = 'produce:validator';
	 ...
	 * @var string
	 */
	protected $description = 'Produce a validator based on your requirements';
	...
	public function fire()
	{
		...
		return $generator->generateValidator();
	}
