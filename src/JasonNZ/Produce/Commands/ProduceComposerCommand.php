...
class ProduceComposerCommand extends Command {
	 ...
	 * @var string
	 */
	protected $name = 'produce:composer';
	 ...
	 * @var string
	 */
	protected $description = 'Produce a view-composer based on your requirements';
	...
	public function fire()
	{
		...
		return $generator->generateComposer();
	}
